...
# 인증이 필요한 모든 엔드포인트의 기본 응답
AUTH_RESPONSES = {
    401: COMMON_401,  # 인증되지 않음
    422: COMMON_422,  # 유효성 검사 실패
    500: COMMON_500,  # 서버 오류
}

# 특정 권한이 필요한 엔드포인트의 응답
AUTH_PERMISSION_RESPONSES = {
    401: COMMON_401,  # 인증되지 않음
    403: COMMON_403,  # 권한 없음 (인증되었지만 권한 부족)
    422: COMMON_422,  # 유효성 검사 실패
    500: COMMON_500,  # 서버 오류
}
